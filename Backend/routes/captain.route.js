...
router.post(
  ...
  [
    ...
    body('vehicle.plate').isLength({min : 5}).withMessage("vehicle plate must be atleast 5 characters"),
    body('vehicle.capacity').isInt({min : 1}).withMessage("vehicle capacity must be atleast 1 characters"),
